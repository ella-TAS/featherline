...
namespace Featherline
{
    ...
    public class RectangleHitbox
    {
        ...
        public RectangleHitbox(int L, int U, int R, int D, bool fromGame)
        {
            this.L = L - 2;
            this.U = U + 4;
            this.R = R + (fromGame ? 2 : 3);
            this.D = D + (fromGame ? 8 : 9);
        }
    ...
    public class Checkpoint : RectangleHitbox
    {
        ...
        public Checkpoint(int L, int U, int R, int D) : base(L, U, R, D, false)
        {
    ...
    public class Spike : RectangleHitbox
    {
        ...
        public Spike(int L, int U, int R, int D, string dir) : base(L, U, R, D, true)
        {
            moveDirAllowsDeath =
            dir switch {
                "Left" => spd => spd.X >= 0f,
    ...
    {
        public Collider(int L, int U, int R, int D, bool fromGame)
            : base(L-1, U-1, R+1, D+1, fromGame) { }
    }
